...
if st.session_state.page_landing:
    ...
    st.markdown(f"""
        <div class="landing">
            ...
            <p>Explorez les comportements, identifiez les segments clés et orientez vos décisions marketing</p>
        </div>
    """, unsafe_allow_html=True)
...
# PAGE 3 - RECOMMANDATIONS
    ...
    show_reco(
        ...
        [
            ...
            "Campagnes USSD simples (#250# par exemple)"
        ],
        "info"
    )
